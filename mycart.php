                ...
                {?>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <td>Fisrt Name:</td>
                                <td ><input style="width: 600px ;" type="text" name="fn"></td>
                            </tr>
                            <tr>
                                <td>Last Name:</td>
                                <td><input style="width: 600px ;" type="text" name="ln"></td>
                            </tr>
                            <tr>
                                <td>Phone No: </td>
                                <td><input style="width: 600px ;" type="text" name="pn"></td>
                            </tr>
                            <tr>
                                <td>Address: </td>
                                <td><input style="width: 600px ;" type="text" name="add"></td>
                            </tr>
                            <tr>
                                <td>Postal Code: </td>
                                <td><input style="width: 600px ;" type="text" name="pc"></td>
                            </tr>
                            <tr>
                                <td>City: </td>
                                <td><input style="width: 600px ;" type="text" name="city"></td>
                            </tr>
                            <tr class="text-center">
                                ...
                                <td colspan="2"><input type="submit" name="invoice" value="GENERATE INVOICE"></td>
                            </tr>
                        </tbody>
                        </table>
                    </form>
